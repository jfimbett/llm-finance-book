...
% ============================================================
\begin{frame}
\frametitle{Recap: Key Formulas (cont.)}
...
% ============================================================
% FRAME 6b: Problem 3 (cont.)
% ============================================================
\begin{frame}
\frametitle{Problem 3: AUROC, KS, and Gini (cont.)}

Recall the portfolio scores $\{0.82, 0.61, 0.45, 0.30, 0.12\}$ with defaults
$\{1, 0, 1, 0, 0\}$ ($n_+ = 2$, $n_- = 3$).
...
% ============================================================
\begin{frame}[fragile]
\frametitle{Case Study: Constrained Decoding in Python (1/2)}

Complete the following code to set up a constrained-decoding generator:
...
% ============================================================
% FRAME 8b: Case study — code sketch (cont.)
% ============================================================
\begin{frame}[fragile]
\frametitle{Case Study: Constrained Decoding in Python (2/2)}

Run the generator on a borrower profile and extract the PD:
...
% ============================================================
\begin{frame}
\frametitle{Solutions: Problem 2}
...
% ============================================================
% FRAME 11b: Solutions — Problem 3
% ============================================================
\begin{frame}
\frametitle{Solutions: Problem 3}
...
% ============================================================
% FRAME 12b: Solutions — Case study HITL tiers
% ============================================================
\begin{frame}
\frametitle{Solutions: Case Study --- HITL Tiers}
...
% ============================================================
\appendixstart{Stretch Problem: TTC Calibration}

\begin{frame}[noframenumbering]{Stretch Problem: Point-in-Time vs.\ Through-the-Cycle}

An LLM credit model trained on 2017--2019 originations produces point-in-time (PIT) PD
estimates. Basel III Pillar 1 requires through-the-cycle (TTC) PDs (long-run average
default rates over a full credit cycle).

\medskip
\textbf{Part A} --- Explain why a PIT model trained only on benign-economy data will
\emph{understate} TTC PD, and what this implies for regulatory capital.

\medskip
\textbf{Part B} --- You recalibrate with Platt scaling, $\hat{p}_{\text{TTC}} = \sigma(a \cdot f(x) + b)$,
on a dataset spanning a full 7--10 year cycle. The fit returns $\hat{a} = 0.85$, $\hat{b} = 0.30$.
Interpret each parameter: which corrects overconfidence, and which shifts for cycle position?

\medskip
\textbf{Part C} --- Your monitoring dashboard reports PSI $= 0.31$ on the bureau-score
feature between the training vintage and the current applicant pool. State the action this
threshold triggers, and connect it to concept drift vs.\ population drift.

\medskip
\begin{center}
\small\textit{Bonus --- attempt only if you finished the core problems early.}
\end{center}
\end{frame}
